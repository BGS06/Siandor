        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left border-collapse min-w-[1100px]">
            <thead className="bg-latar border-b border-border">
              <tr>
                {["No Agenda","Jenis","Nama / Asal Surat","Perihal","NIK","No Surat","Tanggal Terima","Disposisi","Status","Aksi"].map((h) => (
            ...
            <tbody className="divide-y divide-border">
              {isLoading ? (
                ...
                <tr><td colSpan="10" className="py-10 text-center text-sm font-medium text-abu">
                  {searchTerm ? `Tidak ada surat yang cocok dengan "${searchTerm}".` : "Belum ada data surat masuk."}
                </td></tr>
              )}
            </tbody>
          </table>
